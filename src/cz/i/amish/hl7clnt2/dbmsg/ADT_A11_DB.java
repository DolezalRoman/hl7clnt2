/*
 * ADT_A11 - Storno prijmu/pobytu pacienta 
 * 
 * $Id: ADT_A11_DB.java,v 1.2 2017/12/04 12:39:05 raska Exp $
 * $Log: ADT_A11_DB.java,v $
...
/**
 * Trida podporujici zpravu A11 - Storno prijmu/pobytu pacienta 
 * Obsahuje segmenty - MSH, EVN, PID, PV1
 * 
 * @author dolezal
 */
public class ADT_A11_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A11_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A11 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                         ...
                         */
                         ...
                         msg.getMSH().getMessageType().getTriggerEvent().setValue("A11");
