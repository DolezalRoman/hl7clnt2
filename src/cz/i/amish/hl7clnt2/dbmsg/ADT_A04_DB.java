/*
 * ADT_A04 - Prijem pacienta (ambulantni)
 * 
 * $Id: ADT_A04_DB.java,v 1.2 2017/12/04 12:39:06 raska Exp $
 * $Log: ADT_A04_DB.java,v $
...
/**
 * Trida podporujici zpravu A04 - Prijem pacienta (ambulantni)
 * Obsahuje segmenty - MSH, EVN, PID, PV1, IN1
 * 
 * @author dolezal
 */
public class ADT_A04_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A04_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A04 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                         ...
                         */
                         ...
                         msg.getMSH().getMessageType().getTriggerEvent().setValue("A04");
                         ...
                         */
                         ...
                         msg.getADT_A04_IN1IN2IN3().getIN1().getSetIDInsurance().setValue("1");
                         
                         String p_typ_pojist = getStr(rsKom,"typ_pojist"); 
                         if (p_typ_pojist.equals("")) 
 						    p_typ_pojist = "1";
                         msg.getADT_A04_IN1IN2IN3().getIN1().getInsurancePlanID().getIdentifier().setValue("");
                         msg.getADT_A04_IN1IN2IN3().getIN1().getInsurancePlanID().getText().setValue(p_typ_pojist);
                         msg.getADT_A04_IN1IN2IN3().getIN1().getInsurancePlanID().getNameOfCodingSystem().setValue(" ");
 
                         msg.getADT_A04_IN1IN2IN3().getIN1().getInsuranceCompanyID().getID().setValue(getStr(rsKom,"zpoj_kod"));  
