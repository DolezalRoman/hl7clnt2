/*
 * ADT_A02 - Transfer pacienta
 * 
 * $Id: ADT_A02_DB.java,v 1.2 2017/12/04 12:39:06 raska Exp $
 * $Log: ADT_A02_DB.java,v $
...
/**
 * Trida podporujici zpravu A02 - Transfer pacienta
 * Obsahuje segmenty - MSH, EVN, PID, PV1
 * 
 * @author dolezal
 */
public class ADT_A02_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A02_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A02 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                         ...
                         */
                         ...
                         msg.getMSH().getMessageType().getTriggerEvent().setValue("A02");
