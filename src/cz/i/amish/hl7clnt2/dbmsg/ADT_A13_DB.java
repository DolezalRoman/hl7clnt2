/*
 * ADT_A01- Storno propusteni pacienta (stacionarni) 
 *
 * $Id: ADT_A13_DB.java,v 1.2 2017/12/04 12:39:04 raska Exp $
 * $Log: ADT_A13_DB.java,v $
...
/**
 * Trida podporujici zpravu A13 - Storno propusteni pacienta (stacionarni)
 * Obsahuje segmenty - MSH, EVN, PID, PV1
 * 
 * @author dolezal
 */
public class ADT_A13_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A13_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A13 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                        ...
                        */
                        ...
                        msg.getMSH().getMessageType().getTriggerEvent().setValue("A13");
