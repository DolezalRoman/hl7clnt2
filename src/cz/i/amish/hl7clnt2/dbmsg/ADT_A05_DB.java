/*
 * ADT_A05 - Administrativni zalozeni pacienta
 * 
 * $Id: ADT_A05_DB.java,v 1.2 2017/12/04 12:39:05 raska Exp $
 * $Log: ADT_A05_DB.java,v $
 ...
 *
 * Revision 1.3  2005/08/25 08:42:05  raska
...
/**
 * Trida podporujici zpravu A05 - Aktualizace informaci o pacientovi
 * Obsahuje segmenty - MSH, EVN, PID, PV1
 * 
 * @author dolezal
 */
public class ADT_A05_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A05_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A05 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                         ...
                         */
                         ...
                         msg.getMSH().getMessageType().getTriggerEvent().setValue("A05");
                         ...
                         */
                         ...
                         msg.getEVN().getEventTypeCode().setValue("A05");
                         ...
                         */
                         ...
                         msg.getADT_A05_IN1IN2IN3().getIN1().getSetIDInsurance().setValue("1");
                         
                         String p_typ_pojist = getStr(rsKom,"typ_pojist"); 
                         if (p_typ_pojist.equals("")) 
 						    p_typ_pojist = "1";
                         msg.getADT_A05_IN1IN2IN3().getIN1().getInsurancePlanID().getIdentifier().setValue("");
                         msg.getADT_A05_IN1IN2IN3().getIN1().getInsurancePlanID().getText().setValue(p_typ_pojist);
                         msg.getADT_A05_IN1IN2IN3().getIN1().getInsurancePlanID().getNameOfCodingSystem().setValue(" ");
 
                         msg.getADT_A05_IN1IN2IN3().getIN1().getInsuranceCompanyID().getID().setValue(getStr(rsKom,"zpoj_kod"));  
