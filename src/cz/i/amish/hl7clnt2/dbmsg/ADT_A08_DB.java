/*
 * ADT_A08 - Aktualizace informaci o pacientovi
 * 
 * $Id: ADT_A08_DB.java,v 1.2 2017/12/04 12:39:07 raska Exp $
 * $Log: ADT_A08_DB.java,v $
 * Revision 1.2  2017/12/04 12:39:07  raska
 ...
 *
 * Revision 1.5  2005/07/20 10:26:44  raska
 * Opraveny chyby v SELECT prikazech, chybely carky za nekterymi sloupci.
 *
 * Revision 1.4  2005/07/11 16:19:28  raska
...
/**
 * Trida podporujici zpravu A08 - Aktualizace informaci o pacientovi
 * Obsahuje segmenty - MSH, EVN, PID, PV1
 * 
 * @author dolezal
 */
public class ADT_A08_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A08_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A08 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                         ...
                         */
                         ...
                         msg.getMSH().getMessageType().getTriggerEvent().setValue("A08");
                         ...
                         */
                         ...
                         msg.getADT_A08_IN1IN2IN3().getIN1().getSetIDInsurance().setValue("1");
                         
                         String p_typ_pojist = getStr(rsKom,"typ_pojist"); 
                         if (p_typ_pojist.equals("")) 
 						    p_typ_pojist = "1";
                         msg.getADT_A08_IN1IN2IN3().getIN1().getInsurancePlanID().getIdentifier().setValue("");
                         msg.getADT_A08_IN1IN2IN3().getIN1().getInsurancePlanID().getText().setValue(p_typ_pojist);
                         msg.getADT_A08_IN1IN2IN3().getIN1().getInsurancePlanID().getNameOfCodingSystem().setValue(" ");
 
                         msg.getADT_A08_IN1IN2IN3().getIN1().getInsuranceCompanyID().getID().setValue(getStr(rsKom,"zpoj_kod"));  
