/*
 * ADT_A18 - Slouceni pacienta  
 * 
 * $Id: ADT_A18_DB.java,v 1.2 2017/12/04 12:39:03 raska Exp $
 * $Log: ADT_A18_DB.java,v $
 ...
 *
 * Revision 1.4  2005/07/11 16:19:29  raska
...
/**
 * Trida podporujici zpravu A18 - Slouceni pacienta 
 * Obsahuje segmenty - MSH, EVN, PID, MRG, PV1
 * 
 * @author dolezal
 */
public class ADT_A18_DB extends Message_DB implements OutboundMessageDb {
	 ...
	 */
	public ADT_A18_DB(Connection c, Properties prop) {
		super(prop);
		this.con = c;
	}
	...
	/** 
	 * Metoda vytvarejici zpravu A18 z tabulky al7_kom. 
                 ...
                 try {
                      while (rsKom.next()) {
                         ...
                         */
                         ...
                         msg.getMSH().getMessageType().getTriggerEvent().setValue("A18");
                         ...
                         */
                         ...
                         msg.getEVN().getEventTypeCode().setValue("A18");
                         ...
                         */
                         ...
                         setMRGInternalIDs(msg.getMRG(),p_ic_pac_z,p_rod_cis_z);
    					  
                         msg.getMRG().getPriorPatientIDExternal().getID().setValue(p_ic_pac_z);
 					     msg.getMRG().getPriorPatientIDExternal().getAssigningAuthority().getNamespaceID().setValue(prop.getProperty("send_fac_name"));
 					                           
 					     msg.getMRG().getPriorPatientName().getID().setValue(getStr(rsKom,"prijmeni_z"));
                         msg.getMRG().getPriorPatientName().getCheckDigit().setValue(getStr(rsKom,"jm_z"));
